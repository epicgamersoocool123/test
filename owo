...
library.theme = {
    ...
    titlesize = 18,
    font = Enum.Font.Code,
    background = "rbxassetid://8925687489",
    tilesize = 90,
    cursor = false,
    cursorimg = "",
    backgroundcolor = Color3.fromRGB(151, 0, 0),
    tabstextcolor = Color3.fromRGB(242, 243, 243),
    bordercolor = Color3.fromRGB(151, 0, 0),
    accentcolor = Color3.fromRGB(151, 0, 0),
    accentcolor2 = Color3.fromRGB(151, 0, 0),
    outlinecolor = Color3.fromRGB(151, 0, 0),
    outlinecolor2 = Color3.fromRGB(151, 0, 0),
    sectorcolor = Color3.fromRGB(0, 0, 0),
    toptextcolor = Color3.fromRGB(242, 243, 243),
    topheight = 48,
    topcolor = Color3.fromRGB(30, 30, 30),
    topcolor2 = Color3.fromRGB(0, 0, 0),
    buttoncolor = Color3.fromRGB(49, 49, 49),
    buttoncolor2 = Color3.fromRGB(39, 39, 39),
    itemscolor = Color3.fromRGB(242, 243, 243),
    itemscolor2 = Color3.fromRGB(242, 243, 243)
}
